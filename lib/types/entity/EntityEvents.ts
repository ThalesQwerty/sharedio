...
interface EntityFailedCreateEvent<EntityType extends Entity = Entity> {
    user: User,
    entity: EntityType
}
...
export type EntityCreateListener<EntityType extends Entity = Entity> = (event: EntityCreateEvent<EntityType>) => void;
export type EntityFailedCreateListener<EntityType extends Entity = Entity> = (event: EntityFailedCreateEvent<EntityType>) => void;
...
export interface EntityListenerOverloads
    ...
    * Note: this function will not be called if the entity's _Constructor() method returns false, since this implies the entity won't be created.
    */
    (event: "afterCreate", callback: EntityCreateListener): ForceEntity<this>;

    /**
     * If the entity fails to be created (_Constructor() returned false), this event will be emitted.
     */
    (event: "failedCreate", callback: EntityCreateListener): ForceEntity<this>;
}
...
export interface EntityEmitterOverloads
    ...
    (event: "failedCreate", props: EntityFailedCreateEvent<ForceEntity<this>>): void;
}
