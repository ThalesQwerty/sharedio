import { EntityAttribute, EntityBuiltinRoleName, EntityRoleBooleanExpression, EntityRolesData, EntityRolesInterface, EntitySchemaAttribute, KeyValue } from "../types";
